  ...
  const handleSubmit = (e) => {
    ...
    axios.post('https://openx-api.vercel.app/login', { address })
      .then((response) => {
        ...
        localStorage.setItem('address', address);                   // Store address // Store token in localStorage
        setMessage(`Welcome back, ${response.data.userName}!`);
        navigate('/Tweet'); // Redirect to Tweet page
      })
      .catch((error) => {
        ...
        <div className="card-body">
          ...
          <div className="text-center">
            <p>
              ...
              can share their thoughts with confidence, knowing their words are preserved 
              with integrity.
            </p>
          ...
          {address && (
            <p className="mt-3 text-center">Connected Account: {address}</p>
          )}
